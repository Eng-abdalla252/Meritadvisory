...
export function SolutionDetailClient({ solution, related }: SolutionDetailClientProps) {
    ...
    const Icon = iconMap[solution.iconName] || Target
        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-32 min-h-[60vh] flex flex-col justify-center">
                ...
                <div className="absolute inset-0 z-0">
                    <img 
                        src={solution.imageUrl || "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop"} 
                        alt={solution.title}
            ...
            <section ref={benefitsRef} className="py-20 md:py-32">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        >
                            Discover the transformative advantages our {solution.title.toLowerCase()} focus brings to your organization
                        </p>
                    </div>
            ...
            <section className="bg-gradient-to-br from-primary to-accent py-20 text-primary-foreground">
                <div className="mx-auto max-w-4xl px-6 text-center">
                    ...
                    <p className="mt-4 text-lg opacity-90">
                        Let's discuss how our {solution.title.toLowerCase()} expertise can drive measurable results for your organization.
                    </p>
                ...
                <section ref={relatedRef} className="bg-card py-20 md:py-32">
                    <div className="mx-auto max-w-7xl px-6">
                        ...
                        <div className="mt-16 grid gap-8 md:grid-cols-3">
                            {related.map((relatedSolution, i) => {
                                const RelatedIcon = iconMap[relatedSolution.iconName] || Target
                                return (
                                    <Link
                                    ...
                                    >
                                        <Card className="h-full p-6 transition-all hover:-translate-y-2 hover:shadow-xl">
                                            ...
                                            <p className="mt-2 line-clamp-3 text-sm text-muted-foreground">
                                                {relatedSolution.heroDescription}
                                            </p>
